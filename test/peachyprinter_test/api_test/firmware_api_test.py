...
class FirmwareAPITests(unittest.TestCase):
    ...
    def test_required_version_gets_version_from_bin(self, mock_sys, mock_glob, mock_firmware_manager_factory, mock_FirmwareUpdate):
        expected_verison = "1.8.2"
        self._setup_mock(mock_sys, mock_firmware_manager_factory, mock_glob, firmware_version=expected_verison)
        fwapi = FirmwareAPI()
