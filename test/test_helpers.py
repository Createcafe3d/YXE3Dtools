...
class TestHelpers(NumpyTestHelpers,CommandTestHelpers, DefaultsHelpers):
    ...
    def assertConfigurationEqual(self, expected, actual):
        ...
        self.assertEquals(expected.serial.print_start                   , actual.serial.print_start                   , "serial.print_start did not match expected %s was %s"                    % (expected.serial.print_start                   , actual.serial.print_start                   ))
